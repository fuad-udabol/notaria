...
if (isset($data->user_id)) {
    ...
    $allProcedures = mysqli_query($db_conn, "SELECT t.name, t.id, COUNT(*) as count FROM procedures p, procedure_types t WHERE  t.id = p.procedure_type_id AND p.autor_id = $userid GROUP BY t.id");
} else {
